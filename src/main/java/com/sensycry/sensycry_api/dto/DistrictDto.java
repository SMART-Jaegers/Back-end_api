...
public class DistrictDto extends ResourceSupport {
  ...
  public DistrictDto(District district) {
    ...
    add(linkTo(methodOn(DistrictController.class).getDistrict(district.getId())).withSelfRel());

    add(
        linkTo(methodOn(ApartmentController.class).getApartmentsByDistrict(district.getId()))
            .withRel("apartaments"));
  }
