...
public class ApartmentDto extends ResourceSupport {
    ...
    public ApartmentDto(Apartment apartment) {
        ...
        add(linkTo(methodOn(ApartmentController.class).getApartment(apartment.getFamilyId()))
            .withSelfRel());
        
        add(linkTo(methodOn(DeviceController.class).getDevicesByApartment(apartment.getFamilyId()))
            .withRel("device"));
        
        add(linkTo(methodOn(PersonController.class).getPersonsByApartment(apartment.getFamilyId()))
            .withRel("persons"));
        
        add(linkTo(
            methodOn(IncedentController.class).getIncedentsByApartment(apartment.getFamilyId()))
            .withRel("incidents"));
        
        add(linkTo(methodOn(DistrictController.class).getDistrict(apartment.getDistrict().getId()))
            .withRel("district"));
