...
public class PeopleWithProblemsController
  ...
  public PeopleWithProblemsController(PeopleWithProblemsService peopleWithProblemsService) {
  ...
  public ResponseEntity<PeopleWithProblemsDto> deletePeopleWithProblems(@PathVariable Integer id) {
  ...
  @Override
  public List<PeopleWithProblemsDto> createDtos(Iterable<PeopleWithProblems> peoplesWithProblems) {
    ...
    for (PeopleWithProblems peopleWithProblems : peoplesWithProblems) {
      PeopleWithProblemsDto peopleWithProblemsDto = new PeopleWithProblemsDto(peopleWithProblems);
