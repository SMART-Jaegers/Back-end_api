...
public class Incedent {
    ...
    public boolean equals(Object o) {
        ...
        if (duringTime != null ? !duringTime.equals(incedent.duringTime) :
            incedent.duringTime != null) {
            return false;
        }
        if (aggresionHappend != null ? !aggresionHappend.equals(incedent.aggresionHappend) :
        ...
        if (nameRecord != null ? !nameRecord.equals(incedent.nameRecord) :
            incedent.nameRecord != null) {
            return false;
        }
        if (pathRecord != null ? !pathRecord.equals(incedent.pathRecord) :
            incedent.pathRecord != null) {
            return false;
        }
        if (size != null ? !size.equals(incedent.size) : incedent.size != null) {
            return false;
        }
