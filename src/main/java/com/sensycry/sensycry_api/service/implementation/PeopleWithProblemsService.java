...
public class PeopleWithProblemsService
  ...
  @Override
  protected PeopleWithProblems mergeEntities(
      PeopleWithProblems newEntity, PeopleWithProblems entity) {

    newEntity.setConviction(
        entity.getConviction() != null ? entity.getConviction() : newEntity.getConviction());
